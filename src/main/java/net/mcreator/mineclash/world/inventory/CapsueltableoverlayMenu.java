...
package net.mcreator.mineclash.world.inventory;
...
import net.mcreator.mineclash.procedures.CapsuletableoverlaythisguiisclosedProcedure;
import net.mcreator.mineclash.network.CapsueltableoverlaySlotMessage;
import net.mcreator.mineclash.init.MineclashModMenus;
...
public class CapsueltableoverlayMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CapsueltableoverlayMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MineclashModMenus.CAPSUELTABLEOVERLAY, id);
	...
	public void removed(Player playerIn) {
		...
		CapsuletableoverlaythisguiisclosedProcedure.execute(world, x, y, z, entity);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			MineclashMod.PACKET_HANDLER.sendToServer(new CapsueltableoverlaySlotMessage(slotid, x, y, z, ctype, meta));
			CapsueltableoverlaySlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof CapsueltableoverlayMenu) {

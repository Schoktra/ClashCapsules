...
public abstract class DoktorArmorSetItem extends ArmorItem {
	public DoktorArmorSetItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends DoktorArmorSetItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mineclash:textures/models/armor/doktor_armor_layer_1_layer_1.png";
		}
	}
	...
	public static class Leggings extends DoktorArmorSetItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mineclash:textures/models/armor/doktor_armor_layer_1_layer_2.png";
		}
	}

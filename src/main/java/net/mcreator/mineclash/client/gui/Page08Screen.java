...
public class Page08Screen extends AbstractContainerScreen<Page08Menu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, "MineClash offers a", 33, 25, -16777216);
		this.font.draw(poseStack, "big varity of", 33, 43, -16777216);
		this.font.draw(poseStack, "items, therefor", 33, 61, -16777216);
		this.font.draw(poseStack, "there are a big", 33, 79, -16777216);
		this.font.draw(poseStack, "amount of crafting", 33, 97, -16777216);
		this.font.draw(poseStack, "recipes.", 33, 115, -16777216);
	}

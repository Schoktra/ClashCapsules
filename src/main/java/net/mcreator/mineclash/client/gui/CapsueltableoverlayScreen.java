...
public class CapsueltableoverlayScreen extends AbstractContainerScreen<CapsueltableoverlayMenu> {
	private final static HashMap<String, Object> guistate = CapsueltableoverlayMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public CapsueltableoverlayScreen(CapsueltableoverlayMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Capsule Crafting", 6, 9, -12829636);
	}

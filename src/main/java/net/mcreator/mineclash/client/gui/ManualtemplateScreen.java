...
public class ManualtemplateScreen extends AbstractContainerScreen<ManualtemplateMenu> {
	private final static HashMap<String, Object> guistate = ManualtemplateMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ManualtemplateScreen(ManualtemplateMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "This is a dummy text", 37, 61, -16777216);
	}

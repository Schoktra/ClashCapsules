...
import net.mcreator.mineclash.network.Page19ButtonMessage;
...
public class Page19Screen extends AbstractContainerScreen<Page19Menu> {
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 24, this.topPos + 169, 46, 20, new TextComponent("Back"), e -> {
			if (true) {
				MineclashMod.PACKET_HANDLER.sendToServer(new Page19ButtonMessage(0, x, y, z));
				Page19ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}

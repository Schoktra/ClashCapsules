...
public class Page01Screen extends AbstractContainerScreen<Page01Menu> {
	private final static HashMap<String, Object> guistate = Page01Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public Page01Screen(Page01Menu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "The offical", 60, 25, -16777216);
		this.font.draw(poseStack, "MineClash Mod", 51, 43, -16777216);
		this.font.draw(poseStack, "Manual", 69, 61, -16777216);
		this.font.draw(poseStack, "Mod created by", 51, 115, -16777216);
		this.font.draw(poseStack, "Nerdmuffin", 60, 133, -16777216);
	}
